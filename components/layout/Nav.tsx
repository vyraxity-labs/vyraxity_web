...
export function Nav() {
  ...
  const navLinks = [
    { key: "products", href: isHomepage ? "#products" : "/products", label: t("links.products") },
    { key: "labs", href: isHomepage ? "#labs" : "/labs", label: t("links.labs") },
    { key: "vision", href: isHomepage ? "#vision" : "/vision", label: t("links.vision") },
    { key: "about", href: isHomepage ? "#about" : "/about", label: t("links.about") },
    { key: "careers", href: isHomepage ? "#careers" : "/careers", label: t("links.careers") },
  ];
