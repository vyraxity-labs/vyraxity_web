...
export function RelationshipToVyraxity() {
  const t = useTranslations('airacter.relationship')
        ...
        <div ref={sectionRef} className='max-w-3xl'>
          ...
          >
            ...
            <motion.h2
              ...
              className='vx-h2 text-vx-white tracking-tight mb-6'
            >
              {t('heading')}
            </motion.h2>
            ...
            <motion.p
              variants={itemVariants}
              className='vx-body text-vx-muted text-lg sm:text-xl font-light leading-relaxed max-w-2xl'
            >
              {t('copy')}
            </motion.p>
          </motion.div>
