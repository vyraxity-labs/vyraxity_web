...
export function BiggerAmbition() {
  ...
  const bodyCopy = splitIndex !== -1 ? fullCopy.slice(0, splitIndex).trim() : fullCopy;
  ...
  return (
    <Section id="ambition" theme="dark" className="overflow-hidden border-t border-vx-line/40 py-28 md:py-36">
      <Container>
            ...
            {punchline && (
              ...
              >
                <p className="text-2xl sm:text-3xl md:text-4xl font-semibold text-vx-white tracking-tight leading-snug">
                  <span>We are starting small. </span>
                  <span className="text-vx-amber">Our ambition is not small.</span>
                </p>
              </motion.div>
            )}
          </motion.div>
